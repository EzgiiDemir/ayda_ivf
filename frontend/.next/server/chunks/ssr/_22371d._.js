...
function ContactForm({ subjects, submitButtonText }) {
    ...
    const validateForm = ()=>{
        ...
        if (!formData.name?.trim()) {
            newErrors.name = 'Lütfen adınızı ve soyadınızı girin';
        }
        ...
        if (!formData.message?.trim()) {
            newErrors.message = 'Lütfen mesajınızı girin';
        }
        setErrors(newErrors);
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            toast({
                title: '✅ Başarılı',
                description: response.message || 'Mesajınız başarıyla gönderildi!'
            });
            setFormData({
                name: '',
                email: '',
...
//# sourceMappingURL=_22371d._.js.map