(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_40a902._.js", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/config/contact.config.ts [app-client] (ecmascript)");
...
class ContactService {
    ...
    async getContactConfig(locale) {
        if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTACT_CACHE_CONFIG"].enabled) {
        ...
        try {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_CONTACT_CONFIG"];
        }
    }
    async fetchFromApi(locale) {
        const url = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTACT_API_CONFIG"].baseURL}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTACT_API_CONFIG"].endpoint}`;
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(url, {
                ...
                timeout: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTACT_API_CONFIG"].timeout,
                headers: {
    ...
    async submitContactForm(formData) {
        const url = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTACT_API_CONFIG"].baseURL}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTACT_API_CONFIG"].endpoint}/submit`;
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(url, formData, {
                timeout: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTACT_API_CONFIG"].timeout,
                headers: {
                    'Content-Type': 'application/json'
                }
    ...
    getFromCache(locale) {
        const cacheKey = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTACT_CACHE_CONFIG"].key}_${locale}`;
        const cached = this.cache.get(cacheKey);
        if (!cached) return null;
        const now = Date.now();
        const isExpired = now - cached.timestamp > __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONTACT_CACHE_CONFIG"].ttl;
        if (isExpired) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$contact$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/services/contact.service.ts [app-client] (ecmascript)");
...
function ContactForm({ subjects, submitButtonText }) {
    ...
    const onFinish = async (values)=>{
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$contact$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contactService"].submitContactForm({
                ...values,
                locale
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success(response.message || 'Mesajınız başarıyla gönderildi!');
            form.resetFields();
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error(error?.message || 'Bir hata oluştu. Lütfen tekrar deneyin.');
        } finally{
            setLoading(false);
        }
    };
...
_s(ContactForm, "eCVbCY6X05RflGxBGVpRsgZeUc4=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$contact$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/services/contact.service.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/config/contact.config.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$contact$2f$ContactForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/components/contact/ContactForm.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_refresh__.signature();
'use client';
;
...
function ContactPage() {
    ...
    const params = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    const locale = params?.locale || 'tr';
    const [config, setConfig] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_CONTACT_CONFIG"]);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ContactPage.useEffect": ()=>{
            const fetchConfig = {
                "ContactPage.useEffect.fetchConfig": async ()=>{
                    try {
                        setIsLoading(true);
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$contact$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contactService"].getContactConfig(locale);
                        console.log('Contact config loaded:', data);
                        setConfig(data);
                    } catch (error) {
                        console.error('Error fetching contact config:', error);
                        setConfig(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contact$2e$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_CONTACT_CONFIG"]);
                    } finally{
                        setIsLoading(false);
                    }
                }
            }["ContactPage.useEffect.fetchConfig"];
            fetchConfig();
        }
    }["ContactPage.useEffect"], [
        locale
...
_s(ContactPage, "q/jxje7ZD3AMCQkuZ4WSWxN+IcQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"]
    ];
});
...
"[project]/src/app/[locale]/contact/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_40a902._.js.map